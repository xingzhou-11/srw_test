...
class rf_protocol:
    ...
    class ENUM_SORT_ACTION_STATE(Enum):
        SORT_ACTION_STATE_BUSY = {"value": 0x01, "chinese": "忙碌"}
        ...
        SORT_ACTION_STATE_LOAD_TIME_MOTOR_ERROR = {"value": 0x13, "chinese": "装货电机超时"}
        SORT_ACTION_STATE_UNLOAD_TIME_MOTOR_ERROR = {"value": 0x14, "chinese": "卸货电机超时"}
    ...
    class ENUM_PICK_BOX_ACTION(Enum):
        ...
        PICK_BOX_ACTION_CMD_RECOVER_CHAIN_BREAKDOWN = 0x91  # 链条故障恢复
        PICK_BOX_ACTION_CMD_RECOVER_CLAW_BREAKDOWN = 0X92  # 抓钩故障恢复
    ...
    class ENUM_PICK_BOX_STATES(Enum):
        ...
        PICK_BOX_ERROR_CHAIN_BREAKDOWN = {"value": 18, "chinese": "链条故障"}
        PICK_BOX_ERROR_CLAW_BREAKDOWN = {"value": 19, "chinese": "抓钩故障"}
        PICK_BOX_ERROR_CANT_RECOVER_FAIL = {"value": 20, "chinese": "故障恢复失败"}
