...
class parameters:
    ...
    pick_box_action = {
        ...
        "column's_direction": 1,  # 0下降列 1上升列
    ...
    pick_pin_action = {
        ...
        "cmd": rf_protocol.ENUM_PICK_PIN_ACTION_CMD.PICK_PIN_ACTION_CMD_OUT.value,
    ...
    moving_read = {
        "func": rf_protocol.ENUM_FUNCTION_CODE.FUNCTION_CODE_PICK_MOVING_READ.value["value"]
    }
